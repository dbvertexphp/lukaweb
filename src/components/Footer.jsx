...
const Footer = () => {
 return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-gray-300 text-sm">
              <li><a href="/shop" className="hover:text-white transition-colors">Laundry Pods</a></li>
  ...
  <li><Link to="/terms-conditions" className="hover:text-white transition-colors">Terms & Conditions</Link></li>
          ...
          {/* Column 4: Social Icons (Replacing Gmail Box) */}
          <div className="space-y-6">
            <h3 className="text-xl font-bold tracking-tight">Follow Us</h3>
            <div className="flex items-center space-x-6">
              {/* Facebook */}
              <a href="https://www.facebook.com/" className="hover:text-blue-400 transition-colors">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/" className="hover:text-pink-400 transition-colors">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/" className="hover:text-red-500 transition-colors">
        ...
        <div className="pt-12 border-t border-white/10 flex justify-center md:justify-end items-center">
