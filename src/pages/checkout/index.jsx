            ...
            <form onSubmit={handlePlaceOrder} className="space-y-6">
              ...
              <div className="pt-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* COD Button */}
                  <div
                    className={`p-4 rounded-2xl border-2 cursor-pointer transition-all ${formData.paymentMethod === 'COD'
                  ...
                  <div
                    className={`p-4 rounded-2xl border-2 cursor-pointer transition-all ${formData.paymentMethod === 'ONLINE'
                        ? 'border-[#4b70e2] bg-blue-50 shadow-md'
                        : 'border-gray-100 hover:border-blue-200'
                      }`}
              ...
              >
                {isSubmitting ? 'Processing...' : 'Confirm Orderss →'}
              </button>
            </form>
          </div>
